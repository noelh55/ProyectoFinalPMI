...
import com.example.proyectofinalpmi.ActivityMenu;
...
import com.example.proyectofinalpmi.databinding.ActivityMenuBinding;
...
public class ActivityMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_profile, R.id.nav_users, R.id.nav_messages, R.id.nav_groups, R.id.nav_settings)
